...
export function CambiosPage(): JSX.Element {
  const { data, isLoading } = useQuery({ queryKey: ['cambios'], queryFn: loader });

  if (isLoading) return <div>Cargando...</div>;

  return (
    <div className="rounded border bg-white p-4 shadow">
      <h1 className="mb-3 text-xl font-bold capitalize">cambios</h1>
